  ...
  return (
    <div className="relative mt-20 mb-20 flex flex-col items-center px-6 font-serif md:px-20">
      ...
      <div className="mt-10 flex w-full flex-col justify-center gap-2 md:flex-row">
        {/* Image 1 */}
        <div className="group relative w-80 cursor-pointer overflow-hidden rounded-2xl shadow-md md:w-100">
          <div className="h-full w-full cursor-pointer transition-transform duration-500 group-hover:scale-105">
            <Image
              src={img1}
              alt="Image 1"
          ...
          {/* Badge */}
          <span className="absolute top-2.5 right-2.5 z-10 cursor-pointer rounded-full border border-white/30 bg-white/20 px-2.5 py-0.5 text-[11px] font-medium tracking-wide text-white opacity-0 backdrop-blur-sm transition-all duration-300 group-hover:opacity-100">
            Rentals
          </span>

          {/* Overlay */}
          <div className="pointer-events-none absolute inset-0 cursor-pointer bg-gradient-to-t from-black/75 via-black/20 to-transparent opacity-0 transition-opacity duration-500 [clip-path:polygon(28px_0,100%_0,100%_100%,0_100%,0_38px)] group-hover:opacity-100" />

          {/* Text */}
          <div className="absolute right-0 bottom-0 left-0 translate-y-3 cursor-pointer p-3.5 opacity-0 transition-all duration-400 group-hover:translate-y-0 group-hover:opacity-100">
        ...
        {/* Image 3 */}
        <div className="group relative w-80 cursor-pointer overflow-hidden rounded-2xl md:w-100">
          <div className="h-full w-full cursor-pointer transition-transform duration-500 group-hover:scale-105">
            <Image
              src={img3}
              alt="Image 3"
