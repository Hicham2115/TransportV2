    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-full px-8 py-20 text-center">
        ...
        <motion.h1
          ...
          className="mx-auto mb-6 max-w-5xl font-serif text-3xl leading-tight font-light text-white drop-shadow-[0_2px_40px_rgba(10,30,80,0.18)] sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl"
        >
