...
function ThirdSection() {
  return (
    <div className="t relative mt-40 flex flex-col gap-20 px-6 font-serif md:px-20">
      ...
      <div className="flex flex-col items-center gap-12 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex w-full flex-col md:w-1/2">
          ...
          <motion.h3
            ...
            className="mt-10 text-4xl leading-snug font-semibold text-black md:text-5xl"
          >
            In a World
            <br />
            That Never Stops Moving,
            <br />
            <span className="text-black/90">We Keep Your Journey Smarter.</span>
          </motion.h3>
          ...
          <motion.p
            ...
            className="mt-5 max-w-md text-black"
          >
      ...
      <div className="mb-20 flex flex-col gap-10 md:flex-row md:justify-center">
        {[
          ...
          >
            {/* Card */}
            <div className="relative h-full cursor-pointer rounded-2xl border border-brand-red/30 bg-white/10 p-6 backdrop-blur-xl transition-all duration-500">
              {/* Shine effect */}
              ...
              <div className="relative z-10 text-black">
                {/* Icon */}
                <div className="mb-4 flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl bg-brand-red/15 text-brand-red transition-all duration-300 group-hover:scale-110 group-hover:bg-brand-red/25">
                  {card.icon}
                </div>
                ...
                {/* Text */}
                <p className="mt-2 text-sm text-black">{card.desc}</p>
              </div>
            </div>
          </motion.div>
        ))}
