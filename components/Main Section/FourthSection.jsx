  ...
  return (
    <section className="relative z-0 mb-20 flex min-h-[80vh] w-full flex-col items-center justify-center overflow-hidden bg-[#18181a] px-4 py-24">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute top-0 z-0 ml-20 h-[520px] w-full max-w-[900px]"
      >
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true, margin: "-100px" }}
        className="relative z-10 mt-[200px] flex max-w-[700px] flex-col items-center text-center"
      >
        <motion.h2
          variants={itemVariants}
          className="mb-6 text-[clamp(2.8rem,6vw,5rem)] leading-[1.08] font-bold tracking-[-0.03em] text-white"
        >
          Ready to move <br />
        ...
        <motion.p
          variants={itemVariants}
          className="mb-10 max-w-full text-[1.05rem] leading-relaxed font-normal text-white/45"
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="group relative inline-flex w-full items-center justify-center overflow-hidden rounded-lg px-6 py-3 text-white uppercase transition-all duration-300 ease-in-out focus:outline focus:outline-2 focus:outline-offset-4 focus:outline-white sm:w-auto sm:px-8 sm:py-4"
        >
